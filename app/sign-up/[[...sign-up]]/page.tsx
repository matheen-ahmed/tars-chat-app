...
export default function Page() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f5f8f7_0%,_#ece6dc_42%,_#e7e1d7_100%)] p-4">
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-6xl items-center justify-center gap-8">
        <div className="hidden max-w-sm rounded-3xl border border-white/50 bg-white/70 p-8 shadow-[0_20px_60px_-30px_rgba(7,94,84,0.45)] backdrop-blur lg:block">
          <h1 className="text-3xl font-bold text-[#075e54]">Join Connect Chat</h1>
          <p className="mt-3 text-sm text-gray-600">Create your account and start chatting instantly.</p>
          <Link href="/" className="mt-6 inline-block text-sm font-semibold text-[#075e54] underline">
            Back to home
          </Link>
        </div>
